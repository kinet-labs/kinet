...
use kinet_peer_score::PeerStatus;
use thiserror::Error;
...
impl<N> kinet_peer_score::IdentityScore for NopScore<N> {
    type Identity = N;
...
where
    N: Hash + Eq + Send + Sync,
    S: kinet_peer_score::IdentityScore<Identity = N>,
{
    type Identity = N;
...
mod tests {
    ...
    use kinet_peer_score::{PeerStatus, Score};
    ...
    impl kinet_peer_score::IdentityScore for TestScore {
        type Identity = u64;
