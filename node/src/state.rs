...
use kinet_chain_config::KinetChainConfig;
use kinet_consensus_types::validator_data::ValidatorsConfigFile;
use kinet_control_panel::TracingReload;
use kinet_keystore::keystore::Keystore;
use kinet_node_config::{
    ForkpointConfig, MetricsConfig as NodeMetricsConfig, KinetNodeConfig, ValidatorsConfigType,
};
...
impl NodeState {
    pub fn setup(cmd: &mut clap::Command) -> Result<Self, NodeSetupError> {
        ...
        let node_config: KinetNodeConfig =
        ...
        let chain_config =
            KinetChainConfig::new(node_config.chain_id, devnet_chain_config_override)?;
