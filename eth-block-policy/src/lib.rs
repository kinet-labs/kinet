...
use kinet_system_calls::validator::{SystemTransactionValidationError, SystemTransactionValidator};
use kinet_types::{
    ...
    CRT: ChainRevision,
{
        ...
        B: AsRef<EthValidatedBlock<ST, SCT>>,
    {
        ...
        if let Some(parent_block) = extending_blocks.last() {
            ...
            if self.last_commit == GENESIS_SEQ_NUM {
                ...
                (
                    GENESIS_ROUND,
                    kinet_tfm::base_fee::GENESIS_BASE_FEE,
        ...
        B: AsRef<EthValidatedBlock<ST, SCT>>,
    {
        ...
        kinet_tfm::base_fee::compute_base_fee(
...
mod test {
    ...
    use kinet_types::{Balance, Hash, SeqNum};
