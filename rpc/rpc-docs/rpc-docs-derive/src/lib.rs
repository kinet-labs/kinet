...
pub fn rpc(attr_args: TokenStream, decorated: TokenStream) -> TokenStream {
    ...
    TokenStream::from(quote! {
        ...
        #[doc(hidden)]
        impl kinet_rpc_docs::RpcMethod for #name_ident {
        ...
        pub static #info_ident: kinet_rpc_docs::RpcMethodInfo = ::kinet_rpc_docs::RpcMethodInfo {
            name: #method_name,
            docs: #docs,
            input_schema: <#name_ident as kinet_rpc_docs::RpcMethod>::input_schema,
            output_schema: <#name_ident as kinet_rpc_docs::RpcMethod>::output_schema,
            register_components: <#name_ident as kinet_rpc_docs::RpcMethod>::register_components,
        };

        kinet_rpc_docs::inventory::submit! {
            #info_ident
        }
    })
}
