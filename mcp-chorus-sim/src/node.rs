...
use kinet_mcp_chorus::stub as chorus;
use kinet_sim::{Ctx, Handle, StepLabel, Time};
use kinet_sim_swarm::{Net, SimClient};

// using NodeId as Addr
type SimNet<M> = Net<NodeId, M>;

// Both chorus and kinet-sim store time in nanoseconds.
...
// A kinet-sim process that contains a cadence runtime and
    ...
    M: Clone + 'static,
{
    ...
    // interpret all pending runtime events into kinet-sim steps.
