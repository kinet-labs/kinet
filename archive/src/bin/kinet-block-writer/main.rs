...
use kinet_compress::{brotli::BrotliCompression, CompressionAlgo};
use tracing::Level;
...
async fn process_block(
    ...
    let compressed_block: Vec<u8> = {
        ...
        let mut compressed_writer =
            kinet_compress::util::BoundedWriter::new((block_rlp.len().saturating_mul(2)) as u32);
...
mod tests {
    ...
    use kinet_compress::util::BoundedWriter;
    use kinet_eth_types::ReceiptWithLogIndex;
