...
use kinet_types::{Epoch, ExecutionProtocol, NodeId, Round, GENESIS_ROUND};
use kinet_validator::{
...
mod test {
    ...
    use kinet_types::{BlockId, Epoch, SeqNum, Stake};
    use kinet_validator::validator_set::{ValidatorSetFactory, ValidatorSetTypeFactory};
