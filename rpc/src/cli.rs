...
#[derive(Debug, Parser)]
#[command(name = "kinet-rpc", about, long_about = None, version = kinet_version::version!())]
pub struct Cli {
    ...
    /// Set the gas limit for `eth_simulateV1` (default is 8 times Kinet's block gas limit)
    ...
    /// Sets the socket path for the kinet execution event server
    #[arg(long)]
