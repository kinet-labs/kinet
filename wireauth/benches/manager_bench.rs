...
use kinet_wireauth::{messages::Packet, Config, TestContext, API, DEFAULT_METRICS};
...
fn create_test_manager() -> (API<TestContext>, kinet_secp::PubKey, TestContext) {
    let mut rng = rng();
...
fn establish_session(
    ...
    _peer1_public: &kinet_secp::PubKey,
    peer2_public: &kinet_secp::PubKey,
) {
    ...
    peer1_manager
        .connect(
            *peer2_public,
            peer2_addr,
            kinet_wireauth::DEFAULT_RETRY_ATTEMPTS,
        )
