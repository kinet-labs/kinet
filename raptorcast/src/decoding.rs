...
use kinet_validator::validator_set::{ValidatorSet, ValidatorSetType as _};
use rand::Rng as _;
...
pub const DECODING_CACHE_METRIC_PREFIX: &str = "kinet.raptorcast.decoding_cache";
kinet_executor::metric_consts! {
    pub METRIC_RECENTLY_DECODED_HIT {
        name: "kinet.raptorcast.decoding_cache.decoded_hit",
        help: "Hits on recently decoded messages",
    }
    pub METRIC_PENDING_HIT {
        name: "kinet.raptorcast.decoding_cache.pending_hit",
        help: "Hits on pending messages in cache",
    }
    pub METRIC_NEW_ENTRY {
        name: "kinet.raptorcast.decoding_cache.new_entry",
        help: "New entries added to decoding cache",
    }
    pub METRIC_DECODED {
        name: "kinet.raptorcast.decoding_cache.decoded",
...
struct SoftQuotaCacheMetrics {
    pub total_insertions: &'static kinet_executor::MetricDef,
    pub total_evictions_from_overquota_author: &'static kinet_executor::MetricDef,
    pub total_evictions_from_overquota_others: &'static kinet_executor::MetricDef,
    pub total_evictions_from_expiry: &'static kinet_executor::MetricDef,
    pub total_random_evictions: &'static kinet_executor::MetricDef,
    metrics: ExecutorMetrics,
}
...
impl SoftQuotaCacheMetrics {
    pub fn new(prefix: &str, tier: &str) -> Self {
        ...
        let full_def = |name: &str, help: &'static str| -> &'static kinet_executor::MetricDef {
            Box::leak(Box::new(kinet_executor::MetricDef::new(
    ...
    pub fn incr(&mut self, key: &'static kinet_executor::MetricDef, value: usize) {
...
mod test {
    ...
    type PT = kinet_crypto::NopPubKey;
    ...
    fn make_symbols(
        ...
        let encoder = kinet_raptor::Encoder::new(app_message, data_size).unwrap();
