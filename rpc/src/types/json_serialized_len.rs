...
impl JsonSerializedLen for crate::types::eth_json::KinetU256 {
    fn json_serialized_len(&self) -> usize {
        // enclosing double quotes
        2
        // 0x
...
proptest_json_serialized_len!(crate::types::eth_json::KinetU256, kinet_u256, {
    any::<[u8; 32]>().prop_map(|bytes| {
        crate::types::eth_json::KinetU256(alloy_primitives::U256::from_be_bytes(bytes))
    })
});
...
impl JsonSerializedLen for crate::handlers::debug::KinetCallFrameLog {
    fn json_serialized_len(&self) -> usize {
...
proptest_json_serialized_len!(
    crate::handlers::debug::KinetCallFrameLog,
    kinet_call_frame_log,
    {
        use crate::handlers::debug::KinetCallFrameLog;
        ...
        (
            ...
            .prop_map(
                |(address, topics, data, position, index)| KinetCallFrameLog {
                    address,
                    topics,
                    data,
                    position,
...
impl JsonSerializedLen for crate::handlers::debug::KinetCallFrame {
    fn json_serialized_len(&self) -> usize {
...
proptest_json_serialized_len!(crate::handlers::debug::KinetCallFrame, kinet_call_frame, {
    // A call frame with no children, used as the recursion leaf
    fn base() -> impl proptest::prelude::Strategy<Value = crate::handlers::debug::KinetCallFrame> {
        use proptest::prelude::*;

        use crate::handlers::debug::KinetCallFrame;
        ...
        (
            ...
            proptest::option::of(super::test_json_serialized_len__kinet_u256::strategy()),
            super::test_json_serialized_len__quantity::strategy(),
            super::test_json_serialized_len__quantity::strategy(),
            super::test_json_serialized_len__unformatted_data::strategy(),
            super::test_json_serialized_len__unformatted_data::strategy(),
            ...
            proptest::option::of(any::<String>()),
            proptest::collection::vec(
                super::test_json_serialized_len__kinet_call_frame_log::strategy(),
                0..3,
            ),
        )
            .prop_map(
...
impl JsonSerializedLen for crate::handlers::debug::KinetDebugTraceBlockResult {
    fn json_serialized_len(&self) -> usize {
...
proptest_json_serialized_len!(
    crate::handlers::debug::KinetDebugTraceBlockResult,
    kinet_debug_trace_block_result,
    {
        use crate::handlers::debug::KinetDebugTraceBlockResult;

        (
            super::test_json_serialized_len__fixed_data_32::strategy(),
            super::test_json_serialized_len__kinet_call_frame::strategy(),
        )
            .prop_map(|(tx_hash, result)| KinetDebugTraceBlockResult { tx_hash, result })
    }
);
