...
impl PeerNode {
    ...
    fn connect(&mut self, peer_public: kinet_secp::PubKey, peer_addr: std::net::SocketAddr) {
        self.manager
    ...
    fn encrypt_by_public_key(
        &mut self,
        peer_public: &kinet_secp::PubKey,
        plaintext: &mut [u8],
    ) -> kinet_wireauth::Result<kinet_wireauth::messages::DataPacketHeader> {
