...
use kinet_validator::signature_collection::{SignatureCollection, SignatureCollectionError};
...
pub enum NodeSetupError {
    #[error(transparent)]
    Bls12_381(#[from] kinet_bls::BlsError),

    #[error(transparent)]
    ChainConfigError(#[from] kinet_chain_config::ChainConfigError),
    ...
    #[error(transparent)]
    Secp256k1(#[from] kinet_secp::Error),
