...
Standalone and domain-agnostic: it knows nothing about Kinet, consensus, or any
particular message type. Protocol simulations layer on top — for instance
[`kinet-sim-swarm`](../kinet-sim-swarm) (generic network + swarm harness) and
the Kinet BFT mock-swarm harness. See
...
```rust
use kinet_sim::{time::millis, Simulation, StepLabel, Time};
