...
use kinet_types::{NodeId, Round, RoundSpan, GENESIS_ROUND};
...
kinet_executor::metric_consts! {
    pub CLIENT_NUM_CURRENT_GROUPS {
        name: "kinet.bft.raptorcast.secondary.client.num_current_groups",
        help: "Current number of raptorcast secondary groups as client",
    }
    pub CLIENT_RECEIVED_INVITES {
        name: "kinet.bft.raptorcast.secondary.client.received_invites",
        help: "Group invites received as raptorcast secondary client",
    }
    pub CLIENT_RECEIVED_CONFIRMS {
        name: "kinet.bft.raptorcast.secondary.client.received_confirms",
