...
use kinet_peer_discovery::KinetNameRecord;
use kinet_types::{BoundedU64, LimitedVec, NodeId, Round, RoundSpan};
...
pub struct ConfirmGroup<ST: CertificateSignatureRecoverable> {
    ...
    pub name_records: LimitedVec<KinetNameRecord<ST>, MAX_PEERS_IN_GROUP>,
}
...
mod tests {
    ...
    fn make_name_records(seed: u32, count: usize) -> Vec<KinetNameRecord<ST>> {
        (0..count)
            .map(|_| {
