...
mod tests {
    ...
    use kinet_executor_glue::{StateSyncRequest, StateSyncResponse, SELF_STATESYNC_VERSION};
    use kinet_types::NodeId;
    ...
    fn node_id(seed: u8) -> NodeId<NopPubKey> {
        let pubkey =
            <NopPubKey as kinet_crypto::certificate_signature::PubKey>::from_bytes(&[seed; 32])
