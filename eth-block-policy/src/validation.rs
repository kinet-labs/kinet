...
mod test {
    ...
    use kinet_chain_config::{
        execution_revision::KinetExecutionRevision, revision::MockChainRevision, ChainConfig,
        MockChainConfig,
    };
    ...
    fn test_static_validate_transaction() {
        ...
        let result = static_validate_transaction(
            ...
            KinetExecutionRevision::LATEST.execution_chain_params(),
        );
        assert!(matches!(
            result,
        ...
        let input = vec![
            0;
            2 * KinetExecutionRevision::LATEST
