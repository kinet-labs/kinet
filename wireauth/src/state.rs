...
pub struct State {
    ...
    last_established_session_by_public_key: HashMap<kinet_secp::PubKey, EstablishedSessions>,
    ...
    initiated_session_by_peer: HashMap<kinet_secp::PubKey, SessionIndex>,
    accepted_sessions_by_peer: BTreeSet<(kinet_secp::PubKey, SessionIndex)>,
...
impl State {
    ...
    pub fn has_transport_by_public_key(&self, public_key: &kinet_secp::PubKey) -> bool {
    ...
    pub fn has_any_session_by_public_key(&self, public_key: &kinet_secp::PubKey) -> bool {
    ...
    pub fn has_initiator_session_by_public_key(&self, public_key: &kinet_secp::PubKey) -> bool {
    ...
    pub fn get_socket_by_public_key(&self, public_key: &kinet_secp::PubKey) -> Option<SocketAddr> {
        let session_id = self
            .last_established_session_by_public_key
            .get(public_key)
            .and_then(|sessions| sessions.get_latest())?;
    ...
    pub(crate) fn terminate_session(
        ...
        remote_public_key: &kinet_secp::PubKey,
    ...
    pub fn get_max_timestamp(&self, remote_key: &kinet_secp::PubKey) -> Option<Tai64N> {
    ...
    pub fn terminate_by_public_key(&mut self, public_key: &kinet_secp::PubKey) -> Vec<SocketAddr> {
...
pub(crate) fn insert_test_initiator_session(
    ...
    let local_keypair = kinet_secp::KeyPair::generate(&mut rng);
...
mod tests {
    ...
    fn create_test_initiator(remote_public_key: &kinet_secp::PubKey) -> InitiatorState {
    ...
    fn create_test_responder(
        ...
        let mut rng = rng();
        let _local_keypair = kinet_secp::KeyPair::generate(&mut rng);
        ...
        let ephemeral_keypair = kinet_secp::KeyPair::generate(&mut rng);
