...
use kinet_eth_types::{serde::deserialize_eth_address_from_str, EthExecutionProtocol};
use kinet_peer_score::ema;
...
#[cfg(feature = "crypto")]
pub type SignatureType = kinet_secp::SecpSignature;
#[cfg(feature = "crypto")]
pub type SignatureCollectionType =
    kinet_bls::BlsSignatureCollection<CertificateSignaturePubKey<SignatureType>>;
pub type ExecutionProtocolType = EthExecutionProtocol;
#[cfg(feature = "crypto")]
pub type ForkpointConfig = kinet_consensus_types::checkpoint::Checkpoint<
    SignatureType,
...
pub type ValidatorsConfigType =
    kinet_consensus_types::validator_data::ValidatorsConfig<SignatureCollectionType>;
#[cfg(feature = "crypto")]
pub type KinetNodeConfig = NodeConfig<SignatureType>;
