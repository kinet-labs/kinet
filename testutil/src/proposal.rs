...
use kinet_types::{Epoch, ExecutionProtocol, NodeId, Round, SeqNum, GENESIS_ROUND};
use kinet_validator::{
    ...
    EPT: ExecutionProtocol,
{
    ...
    >(
        ...
        let (base_fee, base_fee_trend, base_fee_moment) = kinet_tfm::base_fee::compute_base_fee(
            300_000_000,
            0,
            parent_base_fee,
