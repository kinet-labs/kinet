...
use kinet_triedb_utils::triedb_env::{Triedb, TriedbPath};
...
pub struct KinetBlockStateCall {
    #[schemars(skip)]
    #[serde(default)]
...
#[derive(Debug, Deserialize, schemars::JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct KinetSimulation {
    pub block_state_calls: Vec<KinetBlockStateCall>,
...
#[derive(Debug, Deserialize, schemars::JsonSchema)]
pub struct KinetSimulateParams {
    pub simulation: KinetSimulation,
...
pub async fn kinet_simulate_v1<T: Triedb + TriedbPath>(
...
mod tests {
    ...
    use crate::{
        handlers::eth::simulate::KinetSimulateParams,
    ...
    fn parse_simulate() {
        ...
        let params: KinetSimulateParams = from_str(raw).unwrap();
    ...
    fn parse_simulate_block_overrides() {
        ...
        let _params: KinetSimulateParams = from_str(raw).unwrap();
    }
}
