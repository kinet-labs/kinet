...
impl Metrics {
    ...
    pub fn new_with_otel_provider(provider: SdkMeterProvider) -> Self {
        ...
        let request_duration = meter
            .f64_histogram("kinet.rpc.request_duration")
