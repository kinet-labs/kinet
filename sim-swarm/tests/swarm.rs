...
//! Worked examples for `kinet-sim-swarm`, with toy app-defined node types.
...
use kinet_sim::{time::millis, Ctx, Handle, Simulation, StepLabel, Time};
use kinet_sim_swarm::{deliver_to, Net, Network, SimClient, Swarm};
