...
const IDENTIFIER: &[u8] = b"authenticated udp v1 -- kinet";
...
Nodes include this capability in their KinetNameRecord along with the port number for authenticated connections, allowing peers to identify authentication support and connection details before attempting handshakes.
...
<a id="ref-6"></a>
6. kinet-discovery: future proof name record structure: https://github.com/category-labs/kinet/pull/2042
