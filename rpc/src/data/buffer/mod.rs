...
mod tests {
    ...
    use super::*;
    use crate::types::{
        eth_json::{BlockTags, KinetNotification},
    ...
    fn create_test_block_event(
        ...
        let kinet_header = KinetNotification {
            block_id: BlockId(kinet_types::Hash(block_hash.0)),
            commit_state: BlockCommitState::Proposed,
            data: serialized_header,
        };
        let serialized_kinet_header = JsonSerialized::new_shared(kinet_header);
