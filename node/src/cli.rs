...
#[derive(Debug, Parser)]
#[command(name = "kinet-node", about, long_about = None, version = kinet_version::version!())]
pub struct Cli {
    ...
    /// Set a custom kinet mempool ipc path
    #[arg(long)]
    ...
    /// Set a custom kinet control panel ipc path
    #[arg(long)]
    pub control_panel_ipc_path: PathBuf,

    /// Set a custom kinet statesync ipc path
    #[arg(long)]
