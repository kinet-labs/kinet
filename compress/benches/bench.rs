...
fn bench_txns(c: &mut Criterion) {
    ...
    for compression_level in 0..=kinet_compress::brotli::MAX_COMPRESSION_LEVEL {
        c.bench_function(
    ...
    for compression_level in 0..=kinet_compress::deflate::MAX_COMPRESSION_LEVEL {
        c.bench_function(
    ...
    for compression_level in 0..=kinet_compress::lz4::MAX_COMPRESSION_LEVEL {
        c.bench_function(
