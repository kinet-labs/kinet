...
use kinet_consensus_types::validator_data::{
...
use kinet_secp::{PubKey, SecpSignature};
use kinet_types::{Epoch, SeqNum};
    ...
    fn poll_next(mut self: Pin<&mut Self>, cx: &mut Context<'_>) -> Poll<Option<Self::Item>> {
        ...
        match this.valset_recv.poll_recv(cx) {
            ...
            Poll::Ready(maybe_next_valset) => {
                ...
                Poll::Ready(Some(KinetEvent::ValidatorEvent(
                    kinet_executor_glue::ValidatorEvent::UpdateValidators(
                        validator_set_data_with_epoch,
                    ),
                )))
            }
