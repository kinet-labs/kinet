...
use kinet_archive::{cli::ArchiveArgs, kvstore::WritePolicy, prelude::*};
...
mod tests {
    ...
    use kinet_archive::kvstore::memory::MemoryStorage;
    ...
    fn checker_archive_key_reduces_aws_equality_to_bucket_and_region() {
        let lhs = CheckerArchiveKey(ArchiveArgs::Aws(kinet_archive::cli::AwsCliArgs {
        ...
        let rhs = CheckerArchiveKey(ArchiveArgs::Aws(kinet_archive::cli::AwsCliArgs {
            bucket: "archive-a".to_string(),
            region: Some("us-east-1".to_string()),
    ...
    fn checker_archive_key_preserves_non_aws_identity() {
        let fs = CheckerArchiveKey(ArchiveArgs::Fs(kinet_archive::cli::FsCliArgs {
            path: PathBuf::from("/tmp/archive"),
        }));
        let same_fs = CheckerArchiveKey(ArchiveArgs::Fs(kinet_archive::cli::FsCliArgs {
            path: PathBuf::from("/tmp/archive"),
        }));
        let different_fs = CheckerArchiveKey(ArchiveArgs::Fs(kinet_archive::cli::FsCliArgs {
        ...
        let mongo = CheckerArchiveKey(ArchiveArgs::MongoDb(kinet_archive::cli::MongoDbCliArgs {
            url: "mongodb://host:27017".to_string(),
            db: "db".to_string(),
            replica_name: None,
        }));
        let different_mongo =
            CheckerArchiveKey(ArchiveArgs::MongoDb(kinet_archive::cli::MongoDbCliArgs {
