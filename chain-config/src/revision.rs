...
use kinet_eth_types::MAX_TRANSACTIONS_PER_BLOCK;
...
impl ChainRevision for KinetChainRevision {
    fn chain_params(&self) -> &'static ChainParams {
        match &self {
            KinetChainRevision::V_0_7_0 => &CHAIN_PARAMS_V_0_7_0,
            KinetChainRevision::V_0_8_0 => &CHAIN_PARAMS_V_0_8_0,
            KinetChainRevision::V_0_10_0 => &CHAIN_PARAMS_V_0_10_0,
            KinetChainRevision::V_0_11_0 => &CHAIN_PARAMS_V_0_11_0,
            KinetChainRevision::V_0_12_0 => &CHAIN_PARAMS_V_0_12_0,
        }
    }
}
...
#[cfg(test)]
mod test {
    use crate::revision::KinetChainRevision;

    #[test]
    fn chain_revision_ord() {
        assert!(KinetChainRevision::V_0_7_0 < KinetChainRevision::V_0_8_0);
        assert!(KinetChainRevision::V_0_8_0 < KinetChainRevision::V_0_10_0);
        assert!(KinetChainRevision::V_0_10_0 < KinetChainRevision::V_0_11_0);
        assert!(KinetChainRevision::V_0_11_0 < KinetChainRevision::V_0_12_0);
    }
}
