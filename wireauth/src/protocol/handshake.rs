...
pub struct HandshakeState {
    ...
    pub ephemeral_private: Option<kinet_secp::KeyPair>,
    pub remote_ephemeral: Option<kinet_secp::PubKey>,
    pub remote_static: Option<kinet_secp::PubKey>,
...
pub fn send_handshake_init<R, T>(
    ...
    initiator_static_keypair: &kinet_secp::KeyPair,
    responder_static_public: &kinet_secp::PubKey,
    ...
    T: Into<Tai64N>,
{
    ...
    let ephemeral_keypair = kinet_secp::KeyPair::generate(rng);
...
pub fn accept_handshake_init(
    responder_static_keypair: &kinet_secp::KeyPair,
    ...
    let remote_ephemeral = kinet_secp::PubKey::from_slice(&msg.ephemeral_public)
    ...
    let remote_static = kinet_secp::PubKey::from_slice(&msg.encrypted_static)
        .map_err(|e| HandshakeError::StaticKeyDecryptionFailed(CryptoError::InvalidKey(e)))?;
...
pub fn accept_handshake_response(
    initiator_static_keypair: &kinet_secp::KeyPair,
    initiator_ephemeral_private: &kinet_secp::KeyPair,
...
mod tests {
    ...
    fn test_complete_handshake_trace() {
        ...
        let initiator_static_keypair = kinet_secp::KeyPair::generate(&mut rng);
        let initiator_static_public = initiator_static_keypair.pubkey();
        let responder_static_keypair = kinet_secp::KeyPair::generate(&mut rng);
        let responder_static_public = responder_static_keypair.pubkey();
