...
use kinet_chain_config::{
    execution_revision::KinetExecutionRevision,
...
use kinet_eth_block_policy::{
    compute_txn_max_gas_cost, timestamp_ns_to_secs, EthBlockPolicy, EthBlockPolicyBlockValidator,
    EthValidatedBlock,
};
use kinet_eth_txpool_types::{EthTxPoolDropReason, EthTxPoolInternalDropReason, EthTxPoolSnapshot};
use kinet_eth_types::{EthBlockBody, EthExecutionProtocol, ExtractEthAddress, ProposedEthHeader};
use kinet_execution_state_read::{ExecutionStateRead, ExecutionStateReadError};
use kinet_system_calls::{SystemTransactionGenerator, SYSTEM_SENDER_ETH_ADDRESS};
use kinet_types::{DropTimer, Epoch, NodeId, Round, SeqNum};
    ...
    CertificateSignaturePubKey<ST>: ExtractEthAddress,
{
    ...
    pub fn current_revision(&self) -> (&CRT, &KinetExecutionRevision) {
    ...
    pub fn create_proposal(
        ...
        // Kinet does not use request hashes yet
