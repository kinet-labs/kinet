...
use kinet_types::{Epoch, ExecutionProtocol, Round};
...
mod tests {
    ...
    use kinet_testutil::signing::get_certificate_key;
    use kinet_types::{Epoch, Hash, NodeId, Round, SeqNum, GENESIS_ROUND};
