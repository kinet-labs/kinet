...
use kinet_executor_glue::LogFriendlyKinetEvent;
use kinet_secp::SecpSignature;
use kinet_types::Deserializable;
use kinet_wal::reader::{events_iter_in_range, events_iter_raw, WALReader};
use rayon::iter::{IntoParallelIterator, ParallelIterator};

#[derive(Parser, Debug)]
#[command(name = "wal2json", version = kinet_version::version!(), long_about = "\
...
type WrappedEvent = LogFriendlyKinetEvent<SigType, SigColType, ExecutionProtocolType>;
