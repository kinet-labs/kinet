...
Utility functions to generate the keystore json files for a validator. Run `bash generate_keystores.sh install` in the `kinet-scripts/keystore` directory to generate both a BLS keystore and a SECP keystore file.
