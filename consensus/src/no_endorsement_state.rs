...
use kinet_consensus_types::no_endorsement::NoEndorsementCertificate;
use kinet_crypto::signing_domain;
...
#[cfg(test)]
mod test {
    use kinet_consensus_types::no_endorsement::NoEndorsement;
    use kinet_crypto::{
