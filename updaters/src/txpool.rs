...
use kinet_consensus_types::block::{
...
use kinet_types::{ExecutionProtocol, LimitedVec, SeqNum};
            ...
            match command {
                TxPoolCommand::CreateProposal {
                    ...
                    self.events.push_back(MempoolEvent::Proposal {
                        ...
                        timestamp_ns,
                        round_signature,
                        base_fee: kinet_tfm::base_fee::MIN_BASE_FEE,
                        base_fee_trend: kinet_tfm::base_fee::GENESIS_BASE_FEE_TREND,
                        base_fee_moment: kinet_tfm::base_fee::GENESIS_BASE_FEE_MOMENT,
                        delayed_execution_results,
        ...
        + Unpin,
{
    ...
    type Event = KinetEvent<ST, SCT, MockExecutionProtocol>;
