...
use kinet_executor_glue::Message;
use kinet_types::{LimitedVec, NodeId};

use crate::{KinetNameRecord, PeerDiscoveryEvent, PeerSource};
...
pub struct Ping<ST: CertificateSignatureRecoverable> {
    pub id: u32,
    pub local_name_record: KinetNameRecord<ST>,
}
...
pub struct PeerLookupResponse<ST: CertificateSignatureRecoverable> {
    pub lookup_id: u32,
    pub target: NodeId<CertificateSignaturePubKey<ST>>,
    pub name_records: LimitedVec<KinetNameRecord<ST>, MAX_PEER_IN_RESPONSE>,
}
...
mod test {
    ...
    fn test_ping_rlp_roundtrip() {
        ...
        let ping = Ping {
            id: 257,
            local_name_record: KinetNameRecord::<SignatureType>::new(
                NameRecord::new(
    ...
    fn test_peer_discovery_message_peer_lookup_response_encoding() {
        ...
        let response = PeerLookupResponse {
            ...
            name_records: vec![
                KinetNameRecord::<SignatureType>::new(
                    NameRecord::new(
