...
use kinet_types::{Epoch, ExecutionProtocol, NodeId, Round, Stake, GENESIS_ROUND};
use kinet_validator::{
...
/// [kinet_types::Serializable] is only implemented for Verified.
...
// FIXME-2: move Validated/Unvalidated out of kinet-consensus
...
///
/// See [kinet_consensus_types::timeout::TimeoutInfo::timeout_digest]
...
#[cfg(test)]
mod test {
    use kinet_bls::{BlsSignature, BlsSignatureCollection};
    use kinet_consensus_types::{
        block::{
