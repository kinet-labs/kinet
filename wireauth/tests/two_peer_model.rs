...
mod tests {
    ...
    impl PeerState {
        fn new(peer_id: u8) -> Self {
            ...
            let keypair = kinet_secp::KeyPair::from_bytes(&mut private_key_bytes.clone()).unwrap();
        ...
        fn apply_action(&mut self, action: Action) {
            match action {
                ...
                Action::Reset { peer } => {
                    ...
                    let keypair = kinet_secp::KeyPair::from_bytes(&mut key_bytes).unwrap();
