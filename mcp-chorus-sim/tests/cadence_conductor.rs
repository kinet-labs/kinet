...
//! Exercises the Kinet conductor (window management + deadline-agreement
...
use chorus::{
    conductor::{ConductorConfig, KinetConductor, acs::nop::NopAcs},
    slot::{
...
use kinet_mcp_chorus::{spec::KeyPair as _, stub as chorus};
use kinet_mcp_chorus_sim::CadenceSwarmBuilder;
...
type Conductor = KinetConductor<NopAcs<SlotDeadline>>;
