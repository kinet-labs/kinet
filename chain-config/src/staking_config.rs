...
pub const KINET_DEVNET_STAKING_CONFIG: KinetStakingConfig = KinetStakingConfig {
...
pub const KINET_TESTNET_STAKING_CONFIG: KinetStakingConfig = KinetStakingConfig {
    staking_activation: Epoch(2),
...
pub const KINET_MAINNET_STAKING_CONFIG: KinetStakingConfig = KinetStakingConfig {
...
mod test {
    ...
    fn test_block_reward_activation() {
        let staking_config = KinetStakingConfig {
