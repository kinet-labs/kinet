...
///         name: "kinet.executor.total_exec_us",
///         help: "Total executor execution time in microseconds",
///     }
///     GAUGE_POLL_US {
///         name: "kinet.executor.poll_us",
...
mod tests {
    ...
    metric_consts! {
        TEST_REGISTERED_METRIC {
            name: "kinet.executor.test.registered",
            help: "Test registered metric",
        }
        TEST_INVALID_METRIC {
            name: "kinet.executor.test-invalid",
            help: "Test invalid metric",
        }
        TEST_LEADING_DIGIT_METRIC {
            name: "1kinet.executor.test.invalid",
    ...
    fn prometheus_metric_name_replaces_dots_only() {
        assert_eq!(
            ...
            "kinet_executor_test_registered"
        );
    }
